# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-07-09 18:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0013_product_is_digital'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('billing', '0008_auto_20180623_0108'),
        ('orders', '0008_order_created'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='order',
            options={'ordering': ('-created', 'order_id')},
        ),
    ]
